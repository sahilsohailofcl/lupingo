...
// NOTE: Assuming these are the imported components/types from your project
// import { apiClient } from '@foclupus/utils/apiClient';
// import { Challenge } from '@foclupus/utils/types';
// import { SectionHeader, ChallengeCard, Card, WolfButton } from '@foclupus/ui';
...
// MOCK DATA for all challenges (will be managed locally for the demo)
